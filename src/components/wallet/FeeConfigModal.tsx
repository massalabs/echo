...
const FeeConfigModal: React.FC<FeeConfigModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center md:p-6">
      ...
      {/* Modal */}
      <div
        className={`relative w-full max-w-sm md:max-w-md mx-4 bg-card rounded-2xl shadow-2xl transform transition-all duration-300 ease-out ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
      >
        {/* Header */}
