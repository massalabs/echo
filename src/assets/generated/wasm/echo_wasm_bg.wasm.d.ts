...
export const userpublickeys_secondary_public_key: (a: number) => [number, number];
...
export const usersecretkeys_secondary_secret_key: (a: number) => [number, number];
...
export const generate_user_keys: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const sessionmanagerwrapper_feed_incoming_announcement: (a: number, b: number, c: number, d: number, e: number) => void;
export const sessionmanagerwrapper_get_message_board_read_keys: (a: number) => any;
export const sessionmanagerwrapper_send_message: (a: number, b: number, c: number, d: number) => [number, number, number];
